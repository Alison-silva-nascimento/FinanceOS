...
from database.db import adicionar_recorrencia, gerar_recorrencias, listar_recorrencias
...
for item in listar_recorrencias(): st.write(f"**Dia {item['dia']:02d}** · {item['tipo']} · {item['descricao']} — {moeda(item['valor'])}")
